namespace ServerSuperIO.Device
{
    ...
    ///// <param name="e"></param>
    //public delegate void ReceiveDataHandler(object source, ReceiveDataArgs e);
    ...
    ///// <param name="source"></param>
    ///// <param name="e"></param>
    //public delegate void DeleteDeviceCompletedHandler(object source, DeleteDeviceCompletedArgs e);
